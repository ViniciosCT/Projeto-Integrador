            ...
            <table class="mdl-data-table mdl-js-data-table mdl-shadow--6dp mdl-cell mdl-cell--7-col mdl-cell--7-col-tablet mdl-cell--11-col-desktop">
                ...
                <tbody class="tabela">
                    ...
                    <form action="alterarVeiculo.html" method="post" accept-charset="iso-8859-1,utf-8">
                        ...
                        <input type="hidden" name="cor" value="${veiculo.cor}">
                        <input type="hidden" name="codigo" value="${veiculo.codigo}">

                        <tr>
                            <!-- class "mdl-data-table__cell--non-numeric", align values to left -->
                            <td class="mdl-data-table__cell--non-numeric">${veiculo.placa}</td>
                            <td class="mdl-data-table__cell--non-numeric">${veiculo.modelo}</td>
                            <td class="mdl-data-table__cell--non-numeric">${veiculo.marca}</td>
                            <td>${veiculo.ano}</td>
                            <td class="mdl-data-table__cell--non-numeric">${veiculo.cliente.nome}</td>
                            <td class="mdl-data-table__cell--non-numeric">${veiculo.combustivel}</td>
                            <td class="mdl-data-table__cell--non-numeric">${veiculo.cor}</td>
                            <td class="mdl-data-table__cell--non-numeric">
                                <a href="alterarVeiculo.html">
                                    <button type="submit" class="mdl-color-text--white mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
