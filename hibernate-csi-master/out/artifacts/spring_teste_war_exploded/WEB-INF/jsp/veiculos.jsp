        ...
        <div class="mdl-grid demo-content">
            ...
            <table class="mdl-data-table mdl-js-data-table mdl-shadow--6dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--6-col-desktop">
                ...
                <tr>
                    ...
                    <th class="mdl-data-table__cell--non-numeric">Fase Atual</th>
                ...
                <tr>
                    ...
                    <td class="mdl-data-table__cell--non-numeric">ONIX</td>
                    <td class="mdl-data-table__cell--non-numeric">Chevrolet</td>
                    <td>2016</td>
                    <td class="mdl-data-table__cell--non-numeric">Luis Alves Santos</td>
                    <td class="mdl-data-table__cell--non-numeric">Flex</td>
                    <td class="mdl-data-table__cell--non-numeric">Prata</td>
                    <td class="mdl-data-table__cell--non-numeric">Aguardando Peças</td>
