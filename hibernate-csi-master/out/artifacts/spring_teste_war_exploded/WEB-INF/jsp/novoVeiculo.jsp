        ...
        <div class="mdl-grid demo-content">
            ...
            <div class="mdl-card mdl-shadow--6dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--6-col-desktop">
                <div class="mdl-card__title mdl-color--primary mdl-color-text--white">
                    <h2 class="mdl-card__title-text">Cadastrar Veículo:</h2>
                </div>
                <div class="mdl-grid demo-content">
                    ...
                    <div class="mdl-card__supporting-text mdl-cell mdl-cell--6-col">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input required form="cadastro" class="mdl-textfield__input" type="text" id="placa" name="placa">
                            <label form="cadastro" class="mdl-textfield__label" for="placa">Placa</label>
                        </div>

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input required form="cadastro" class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="ano" name="ano">
                            <label class="mdl-textfield__label" for="ano">Ano</label>
                            <span class="mdl-textfield__error">Este valor não é um numero!</span>
                        </div>

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input required form="cadastro" class="mdl-textfield__input" type="text" id="modelo" name="modelo">
                            <label form="cadastro" class="mdl-textfield__label" for="modelo">Modelo</label>
                        </div>

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input required form="cadastro" class="mdl-textfield__input" type="text" id="marca" name="marca">
                    ...
                    <div class="mdl-card__supporting-text mdl-cell mdl-cell--6-col">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input required form="cadastro" class="mdl-textfield__input" type="text" id="combustivel" name="combustivel">
                            <label form="cadastro" class="mdl-textfield__label" for="combustivel">Combustível</label>
                        </div>

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input required form="cadastro" class="mdl-textfield__input" type="text" id="cor" name="cor">
