    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
            ...
            <table class="mdl-data-table mdl-js-data-table mdl-shadow--6dp mdl-cell mdl-cell--7-col mdl-cell--7-col-tablet mdl-cell--11-col-desktop">
                ...
                <form action="alterarCliente.html" method="post" accept-charset="iso-8859-1,utf-8">
                    <input type="hidden" name="nome" value="${cli.nome}">
                    <input type="hidden" name="telefone" value="${cli.telefone}">
                ...
                <tr>
                    ...
                    <td class="mdl-data-table__cell--non-numeric">${cli.telefone}</td>
                    <td class="mdl-data-table__cell--non-numeric">${cli.email}</td>
