        ...
        <div class="mdl-grid demo-content">
            ...
            <div class="mdl-card mdl-shadow--6dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--6-col-desktop">
                <div class="mdl-card__title mdl-color--primary mdl-color-text--white">
                    <h2 class="mdl-card__title-text">Orçamento gerado corretamente!</h2>
                </div>
                <div class="mdl-grid demo-content">

                    <form action="transformaOrcamentoEmOS.html" id="cadastro" method="post" accept-charset="iso-8859-1,utf-8">
                        <input type="hidden" name="codOrcamento" value="${orcamento.codigo}">
                    </form>
                    <div class="mdl-card__supporting-text mdl-cell mdl-cell--12-col">

                        <div class="mdl-textfield mdl-js-textfield">
                            <p>Deseja gerar Ordem de serviço?</p>
                            <input form="cadastro" type="radio" name="gerarOS" value="true" checked> Sim<br>
                            <input form="cadastro" type="radio" name="gerarOS" value="false"> Não<br>
                        </div>
                ...
                <div class="mdl-card__actions mdl-card--border">
                    <button form="cadastro" type="submit" class="mdl-color-text--white mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Confirmar</button>
                </div>
            </div>
