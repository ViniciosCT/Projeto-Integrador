        ...
        <header class="demo-drawer-header">
            ...
            <div class="demo-avatar-dropdown">
                ...
                <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="accbtn">
                    <a href="sair.html"><li class="mdl-menu__item">Sair</li></a>
                    <!--<li class="mdl-menu__item"><i class="material-icons">add</i>Add another account...</li>-->
                </ul>
            </div>
        </header>
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
            <a class="mdl-navigation__link mdl-button--raised mdl-button--colored mdl-color-text--blue-grey-50" href="paginaInicial.html"><i class="mdl-color-text--blue-grey-50 material-icons" role="presentation">home</i>Pagina Inicial</a>
        ...
        <div class="mdl-grid demo-content">
            ...
            <div class="mdl-card mdl-shadow--6dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--6-col-desktop">
                <div class="mdl-card__title mdl-color--primary mdl-color-text--white">
                    <h2 class="mdl-card__title-text">Relatório Geral:</h2>
                </div>
                <div class="mdl-grid demo-content">
